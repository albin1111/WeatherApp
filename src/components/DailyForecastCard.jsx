...
const DailyForecastCard = () => {
  ...
  return (
    // wcard-hover
    <div className='flex flex-col gap-5 snap-start wcard ' onClick={() => { handleExpand() }}>
      ...
      <div className='flex gap-5'>
        <div className='flex flex-col items-center justify-between gap-5'>
          {/* degrees */}
          <div className='order-last text-5xl font-semibold'>16°</div>
          {/* icon */}
        ...
        {expand && (
          <div className='flex'>
            <div className='flex h-full responsive-gap md:w-full md:flex-row'>
              <div className='flex flex-col gap-3 md:gap-5 md:mx-auto'>
                {/* realFeel */}
                <p className='text-sm text-nowrap'>Real Feel: <span className='block text-base font-medium lg:text-md xl:text-xl'>999°C</span></p>
                {/* wind */}
                <p className='text-sm text-nowrap'>Wind: <span className='block text-base font-medium lg:text-md xl:text-xl'>999 km/h</span></p>
                {/* pressure */}
                <p className='text-sm text-nowrap'>Pressure: <span className='block text-base font-medium lg:text-md xl:text-xl'>999 mb</span></p>
              </div>
              <div className='flex flex-col gap-3 md:gap-5 md:mx-auto'>
                {/* humidity */}
                <p className='text-sm text-nowrap'>Humidity: <span className='block text-base font-medium lg:text-md xl:text-xl'>999%</span></p>
                {/* sunrise */}
                <p className='text-sm text-nowrap'>Sunrise: <span className='block text-base font-medium lg:text-md xl:text-xl'>999</span></p>
                {/* sunset */}
                <p className='text-sm text-nowrap'>Sunset: <span className='block text-base font-medium lg:text-md xl:text-xl'>999</span></p>
              </div>
            </div>
          </div>
        )}
